...
const navItems = [
  ...
  {
    label: "Explanation Report",
    href: "/explanation-report",
...
export default function Sidebar() {
  ...
  return (
    <aside className="flex min-h-screen w-64 flex-col bg-slate-900 text-slate-100">
      {/* Logo */}
      <div className="flex items-center gap-3 border-b border-slate-800 px-6 py-6">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-600">
          <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d={SHIELD} />
          </svg>
        </div>
      ...
      {/* Footer status */}
      <div className="border-t border-slate-800 px-6 py-5 text-xs">
        <p className="font-semibold text-slate-200">System Status</p>
        <p className="mt-1 flex items-center gap-1.5 text-green-400">
          <span className="h-2 w-2 rounded-full bg-green-400" /> All systems operational
        </p>
        <p className="mt-3 text-slate-400">Model Version</p>
